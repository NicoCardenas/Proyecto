...
public class Tablero{
    ...
    private Celula[][] tablero1;
    private Celula[][] tablero2;
    private Celula[][] tablero3;
    private Celula[][] tablero4;
    ...
    public Tablero(int width, int height){
        tablero1 = new Celula[width][height];
        tablero2 = new Celula[width][height];
        tablero3 = new Celula[width][height];
        tablero4 = new Celula[width][height];
        ...
        if (!fin){
            ...
            for (int i = 0; i < tablero1.length; i++){
                for (int j = 0; j < tablero1[0].length; j++){
                    ...
                    if (tablero1[i][j].getType() == "normal")
                        tablero3[i][j] = new Normal(tablero3[i][j].getPositionX(),tablero3[i][j].getPositionY(),size,tablero3[i][j].getColorOrigin());
                    else if (tablero1[i][j].getType() == "even")
                        tablero3[i][j] = new Even(tablero3[i][j].getPositionX(),tablero3[i][j].getPositionY(),size,tablero3[i][j].getColorOrigin());
                    else if (tablero1[i][j].getType() == "rigid")
                        tablero3[i][j] = new Rigid(tablero3[i][j].getPositionX(),tablero3[i][j].getPositionY(),size,tablero3[i][j].getColorOrigin());
                    else if (tablero1[i][j].getType() == "immune")
                        tablero3[i][j] = new Immune(tablero3[i][j].getPositionX(),tablero3[i][j].getPositionY(),size,tablero3[i][j].getColorOrigin());
                    else if (tablero1[i][j].getType() == "social")
                        tablero3[i][j] = new Social(tablero3[i][j].getPositionX(),tablero3[i][j].getPositionY(),size,tablero3[i][j].getColorOrigin());
                    else if (tablero1[i][j].getType() == "floja")
                        tablero3[i][j] = new Floja(tablero3[i][j].getPositionX(),tablero3[i][j].getPositionY(),size,tablero3[i][j].getColorOrigin());
        ...
        if (!fin){
            ...
            for (int i = 0; i < tablero1.length; i++){
                for (int j = 0; j < tablero1[0].length; j++){
                    ...
                    //tablero3[i][j].makeVisible();
                    //tablero4[i][j].makeVisible(); 
                }
                estado = true;
            }
            isVisible = true;
    ...
    public void rotate(){
        if (!fin){
            estado = false;       
            makeInvisible();
            tablero3 = new Celula[tablero1[0].length][tablero1.length];
            tablero4 = new Celula[tablero1[0].length][tablero1.length];
            int a,b;
            for (int i = 0; i < tablero1.length; i++){
                for (int j = 0; j < tablero1[0].length; j++){
    ...
    public void mutate(String type, int[][] cells){
        if (!fin){
            ...
            for (int i = 0; i < cells.length; i++){
                if (0 <= cells[i][0]-1 && cells[i][0]-1 < tablero1.length && 0 <= cells[i][1]-1 && cells[i][1]-1 < tablero1[0].length){
                    mutate(type, cells[i][1], cells[i][0]);
                    estado = true;
                }                           
            }
        }
    ...
    public int getValue(int x, int y, Celula[][] tablero){
        int res = 0;
    ...
    public String[] solve(){
        String[] res = new String[tablero2.length];
     ...
     */
    private void cloneT(Celula[][] tablero1, Celula[][] tablero2){
        estado = false;
        for (int i = 0; i < tablero1.length; i++){
            for (int j = 0; j < tablero1[0].length; j++){                
                if (tablero2[i][j].getType() == "normal"){
                    tablero1[i][j] = new Normal(tablero1[i][j].getPositionX(),tablero1[i][j].getPositionY(),size,tablero1[i][j].getColorOrigin());
                    tablero1[i][j].changeColor(tablero2[i][j].getColor());
                }else if (tablero2[i][j].getType() == "even"){
                    tablero1[i][j] = new Even(tablero1[i][j].getPositionX(),tablero1[i][j].getPositionY(),size,tablero1[i][j].getColorOrigin());
                    tablero1[i][j].changeColor(tablero2[i][j].getColor());
                }else if (tablero2[i][j].getType() == "rigid"){
                    tablero1[i][j] = new Rigid(tablero1[i][j].getPositionX(),tablero1[i][j].getPositionY(),size,tablero1[i][j].getColorOrigin());
                    tablero1[i][j].changeColor(tablero2[i][j].getColor());
                }else if (tablero2[i][j].getType() == "immune"){
                    tablero1[i][j] = new Immune(tablero1[i][j].getPositionX(),tablero1[i][j].getPositionY(),size,tablero1[i][j].getColorOrigin());
                    tablero1[i][j].changeColor(tablero2[i][j].getColor());
                }else if (tablero2[i][j].getType() == "social"){
                    tablero1[i][j] = new Social(tablero1[i][j].getPositionX(),tablero1[i][j].getPositionY(),size,tablero1[i][j].getColorOrigin());
                    tablero1[i][j].changeColor(tablero2[i][j].getColor());
                }else if (tablero2[i][j].getType() == "floja"){
                    tablero1[i][j] = new Floja(tablero1[i][j].getPositionX(),tablero1[i][j].getPositionY(),size,tablero1[i][j].getColorOrigin());
                    tablero1[i][j].changeColor(tablero2[i][j].getColor());
                }
            }
        }        
    ...
    private String patron(Celula cuad){
        String a = "";
